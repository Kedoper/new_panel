...
$cart = json_decode($report_search['basket'], true);
$user = R::load('users',$_SESSION['logged_user']['id']);

$cart_info = [];
$i = 1;
foreach ($cart as $item) {
    $pub = R::findOne('pubs', "p_id = ?", [$item['pub_id']]);
    $cart_info[] = [
        'num' => $i,
        'title' => $pub['title'],
        'price' => $pub['price'],
        'thematic' => $pub['thematic'],
            ...
            <div class="col">
                <div class="info-row d-flex">
                    <div class="info-row__left-side">
                        ...
                        <p>Очет создал: <span><?= $user['login'] ?></span></p>
                        ...
                        <p>Доля White Price %/руб:
                            <span><?= round($pr, 2) ?>/<?= $report_search['total_price'] ?></span></p>
                        <p>Ссылка на клиента: <span><a
                                        href="//vk.com/id<?= $report_search['client'] ?>">ссылка</a></span></p>
...
<script src="/js/reportInfo.js"></script>
</html>